...
pub struct Swagger {
    ...
    #[prost(enumeration = "swagger::SwaggerScheme", repeated, tag = "5")]
...
/// Nested message and enum types in `Swagger`.
pub mod swagger {
    #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
    #[repr(i32)]
    pub enum SwaggerScheme {
        Unknown = 0,
        Http = 1,
        Https = 2,
        Ws = 3,
...
pub struct Schema {
    ...
    pub example: ::core::option::Option<::prost_types::Any>,
}
